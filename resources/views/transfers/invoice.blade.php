...
@section('title', trans('transfers.invoice'))

@section('content')
	<section class="content-header">
		<h1>
			{{trans('transfers.invoice')}}
		</h1>
	</section>
	...
	<section class="content" id="invoice">
		<div class="row">
		    ...
		    <div class="row no-print">
		      <div class="col-xs-12">
		        <button id="btn-print-invoice" class="btn btn-success pull-right"><i class="fa fa-print"></i> Print</button>
		       {{--  <a href="{{route('pdf.invoice', $log->id)}}" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</a> --}}
		      </div>
		    </div>
