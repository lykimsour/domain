    ...
    <div class="col-md-12">
      <ul class="list-group">
        <li class="list-group-item"><span class="glyphicon glyphicon-list-alt"></span>
            <span>List / <a href="{{ route('usertoshoplog')}}">{{ $user->user->name }}</a>
                       / <a href="{{ route('detailusertoshoplog', [$user->user->id, Request::segment(4), Request::segment(5), Request::segment(6)])}}">{{ $service_code }}</a>
            </span> 
        </li>
      </ul>
