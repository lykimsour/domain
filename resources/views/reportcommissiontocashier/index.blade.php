...
<h2>{{trans('Report:Commission_To_Cashier')}}</h2>
...
<div class="row">
    <div class="col-md-12">
      ...
      <ul class="list-group">
        ...
        {!! Form::open(array('action' => array('ReportCommissionToCashierController@index'), 'method' => 'POST', 'class' => 'form-inline')) !!}
          ...
          {!! $reports->render() !!}
            ...
            @foreach($reports as $report)
              ...
              <tr>
                ...
                <td>{{ $report->date }}</td>
                <td><a href="{{ route('detailcommissiontocashier', ['id' => $report->cashier_id]) }}">Detail</a></td>
              </tr>
            @endforeach
